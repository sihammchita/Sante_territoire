...
with k4:
    st.markdown(f'<div class="kpi-card"><div class="kpi-value">{avg_acces:.1f} min</div><div class="kpi-label">Accès généraliste</div></div>', unsafe_allow_html=True)
with k5:
...
with tabs[0]:
    ...
    with c1:
        map_metric = st.selectbox("Indicateur cartographié", [
            "Score global santé","Généraliste le plus proche (min)","Professionnels pour 100k hab.",
